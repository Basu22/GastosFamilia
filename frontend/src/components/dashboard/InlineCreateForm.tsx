          ...
          {tipo === 'tarjeta' ? (
            <div className="col-span-full grid grid-cols-1 md:grid-cols-2 gap-4 bg-white dark:bg-neutral-900 p-4 rounded-2xl border border-gray-100 dark:border-neutral-800">
              ...
              <div className="space-y-3">
                ...
                <input type="number" {...register('cuotas', { valueAsNumber: true })} className="w-full px-4 py-2 rounded-xl border border-gray-200 bg-gray-50 text-xs font-bold" placeholder="Manual..." />
              </div>
            </div>
          ) : (
            <div className="space-y-1">
